...
if(isset($_GET['check_availability']))
{
    ...
    //adding this filter for city
    $city = $_GET['city']; // Retrieve the city from the URL parameters
                ...
                <div class="container-fluid flex-lg-column align-items-stretch">
                    ...
                    facilities;
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            ...
                            <input type="text" class="form-control shadow-none" id="city" placeholder="Enter city name" oninput="fetch_rooms()">
                        </div>

                        <!-- Search Button -->
                        <div class="text-center mt-3">
                            <button onclick="fetch_rooms()" class="btn text-white shadow-none custom-bg">Search</button>
                        </div>
...
<script>
    ...
    function fetch_rooms()
    {
        ...
        let city = document.getElementById('city').value; // Moved inside the function
        ...
        let chk_avail = JSON.stringify({
            ...
            /*
                      city: document.getElementById('city').value // Assuming you have an input field with id="city"
            */
        });
       ...
       //city and availability filters
        xhr.open("GET", `ajax/rooms.php?fetch_rooms&city=${city}&chk_avail=${chk_avail}&guests=${guests}&facility_list=${facility_list}`, true);
