<?php 
  ...
  if(isset($_POST['get_bookings']))
  {
    ...
    $query = "SELECT bo.*, bd.* FROM `booking_order` bo
      ...
      WHERE (bo.order_id LIKE ? OR bd.phonenum LIKE ? OR bd.user_name LIKE ?) OR (bo.booking_status='pending' )
  ...
  if(isset($_POST['assign_room']))
  {
    ...
    $query = "UPDATE `booking_order` bo INNER JOIN `booking_details` bd
      ...
      SET bo.arrival = ?, bo.rate_review = ?, bd.room_no = ? , bo.booking_status = 'booked' 
      WHERE bo.booking_id = ?";
