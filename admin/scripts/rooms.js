...
//added
let hotel_id_select = document.getElementById('hotel_id');
//added
add_room_form.addEventListener('submit',function(e){
  e.preventDefault();
  // Check if a hotel is selected
  if(hotel_id_select.value === "") {
    alert('Please select a hotel before adding a room.'); // Alert if no hotel is selected
...
*/
  ...
  console.log(hotel_id_select.value); // For debugging: log the selected hotel_id to the console
  add_room();
});
